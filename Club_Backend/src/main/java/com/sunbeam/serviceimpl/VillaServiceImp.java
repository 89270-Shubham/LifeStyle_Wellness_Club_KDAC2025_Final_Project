...
// .orElseThrow(() -> new ResourceNotFoundException("Invalid restaurant
// ID!!!!"));
// // map entity -> dto
// /*
// * API of ModelMapper public <D> D map(Object src, Class<D> destinationClass);
// * 1. create dest class instance - using def constructor 2. calls getter on
// src
...
// // set status - true
// entity.getStatus(Ac // invoke dao's - inherited API
